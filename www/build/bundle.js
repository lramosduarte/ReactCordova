...
/***/ function(module, exports, __webpack_require__) {
	...
	var BoxTarefas = __webpack_require__(160);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDOM = __webpack_require__(158);
	var $ = __webpack_require__(159);
	var Detalhes = __webpack_require__(161);

	var ListaTarefas = React.createClass({
	  displayName: 'ListaTarefas',
	      ...
	      listaTarefas.map(tarefa => {
	        return React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              'button',
	              { className: 'btn label label-danger col-xs-2', onClick: this.deleteElement },
	              ' Excluir '
	            )
	          )
	        );
	  ...
	  render: function () {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          'div',
	          { className: 'row cabecalho' },
	          React.createElement(
	            'div',
	            { className: 'col-xs-7' },
	            React.createElement('input', { className: 'btn', type: 'text', id: 'descricao', name: 'descricao', value: this.state.descricao, placeholder: 'Descricao...', onChange: this.handleDescricaoChange })
	          ),
	          React.createElement(
	            'div',
	            { className: 'col-xs-1' },
	            React.createElement('input', { className: 'btn', type: 'checkbox', id: 'concluido', name: 'concluido', value: this.state.concluido, onChange: this.handleConcluidoChange })
	          ),
	          React.createElement(
	            'div',
	            { className: 'col-xs-4' },
	            React.createElement('input', { className: 'btn', type: 'submit', value: 'Salvar' })
	          )
	        )
	      )
	    );
	  ...
	  render: function () {
	    return React.createElement(
	      ...
	      React.createElement(
	        'div',
	        { className: 'row' },
	        React.createElement(TarefasForm, { onTarefaSubmit: this.handleTarefaSubmit }),
	        ';'
	      ),
	      React.createElement(
	        'div',
